...
public class SocketDoesntClose extends Responder {
    ...
    Protocol prot = new Protocol("mail", "/Users/alina/project/avro/src/main/resources/avro/mail.avsc");

    // start on port 9999
    InetSocketAddress addr = new InetSocketAddress(InetAddress.getLocalHost(), 9093);
